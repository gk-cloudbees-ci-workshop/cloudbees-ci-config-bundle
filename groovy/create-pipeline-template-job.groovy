...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/gk-cloudbees-ci-workshop/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>gk-cloudbees-ci-workshop</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>gk-cloudbees-ci-workshop</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/gk-cloudbees-ci-workshop/pipeline-template-catalog.git</repositoryUrl>
              <traits>
